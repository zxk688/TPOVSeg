...
COCO_CATEGORIES = [
    {"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "building"},
    {"color": [119, 11, 32], "isthing": 1, "id": 2, "name": "road"},
    {"color": [0, 0, 142], "isthing": 1, "id": 3, "name": "water"},
    {"color": [0, 0, 230], "isthing": 1, "id": 4, "name": "barren"},
    {"color": [106, 0, 228], "isthing": 1, "id": 5, "name": "forest"},
    {"color": [0, 60, 100], "isthing": 1, "id": 6, "name": "agriculture"},
    {"color": [0, 80, 100], "isthing": 1, "id": 7, "name": "bus"},
...
def register_all_coco_stuff_10k(root):
    ...
    # root = '/media/lscsc/nas/xianping/ZXK/PublicDatasets/coco-stuff'
    root = './datasets/coco-stuff'
